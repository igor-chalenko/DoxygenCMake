...
#
# **DOCS_TARGET**
#     The name of the `Doxygen` target. The default is
...
# project file and need to change some `DoxygenCMake` settings, or you need
...
# path. For example, the following command will instruct `Doxygen` to inline
...
#
#   The default template generated by `Doxygen` sets these to ``false``,
...
#   as stated in `Doxygen` documentation (and originally in `Doxygen`'s).
#
...
#   to update is defined by :cmake:command:`_doxygen_init_properties`.
